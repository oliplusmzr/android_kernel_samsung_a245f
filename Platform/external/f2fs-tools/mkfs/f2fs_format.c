...
static int f2fs_prepare_super_block(void)
{
	...
	set_sb(block_count, (c.total_sectors + c.rsvd_meta_sectors) >> log_sectors_per_block);
	...
	extra_segments = (c.rsvd_meta_sectors * c.sector_size) / segment_size_bytes;
	set_sb(segment_count, ((c.total_segments + extra_segments) /
					c.segs_per_zone * c.segs_per_zone));
	...
	/* Restore block_count and segment count */
