...
#define OPT_RESERVE_META    (SEC_OPT_START + 3)
...
static void mkfs_usage()
{
	...
	MSG(0, "  --reserve-metadata=#  # of extra sectors for reserve metadata\n");
...
static void f2fs_parse_options(int argc, char *argv[])
{
	...
	static const struct option long_opts[] = {
		...
		{"reserve-metadata", required_argument, NULL, OPT_RESERVE_META},
		{NULL, 0, NULL, 0}
	};
	int32_t option=0;
	int val;
